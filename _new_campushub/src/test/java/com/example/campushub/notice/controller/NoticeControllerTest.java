...
//
//        // When
//        ResponseEntity<?> response = noticeController.createNotice(requestDto, loginUser);
//
//        // Then
//        assertThat(response.getStatusCode().is2xxSuccessful()).isTrue(); // 상태 코드 검증
//
...
//
//        // When
//        ResponseEntity<?> response = noticeController.deleteNotice(notice.getId(), loginUser);
//
//        // Then
//        assertThat(response.getStatusCode().is2xxSuccessful()).isTrue(); // 상태 코드 검증
//
