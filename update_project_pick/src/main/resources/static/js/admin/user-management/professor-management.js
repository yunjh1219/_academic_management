...
document.getElementById('admin-profinfo-searchBtn').addEventListener('click',function () {
    ...
    // 입력된 학과와 학번 가져오기
    const deptName = document.getElementById('admin_profmana_deptName').value;
    const userNum = document.getElementById('admin_usermana_profNum').value;

    const params = new URLSearchParams();
    if (deptName) params.append('deptName', deptName);
    if (userNum) params.append('userNum', userNum);
