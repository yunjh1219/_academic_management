...
public class AuthController {
	...
	@PostMapping("/api/changeps/{userNum}")
	@ResponseStatus(HttpStatus.OK)
	public SuccessResponse<Void> changePassword(LoginUser loginUser, @RequestBody PasswordChangeRequest request, @PathVariable String userNum){
